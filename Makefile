...
gen-packer-aem:
	...
	$(call gen_packer_aem,aws,rhel9,aem64,jdk8)
	$(call gen_packer_aem,aws,rhel9,aem65,jdk8)
	$(call gen_packer_aem,aws,rhel9,aem65,jdk11)
	...
	$(call gen_packer_aem,aws,amazon-linux2023,aem64,jdk8)
	$(call gen_packer_aem,aws,amazon-linux2023,aem65,jdk8)
